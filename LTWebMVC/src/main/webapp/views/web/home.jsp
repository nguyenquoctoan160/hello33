                    	...
                    	<c:forEach items="${productList }" var="product" varStatus="Stt">	                    
	                        <div class="col-sm">
	                            <div class="card">
	                                ...
	                                <div class="card-body">
	                                    <h4 class="card-title"><a href="<%=request.getContextPath() %>/user/product?productId=${product.productId }" title="View Product">${product.productName }</a></h4>
...
<div class="container mt-3 mb-4">
    <div class="row">
        <div class="col-sm">
            <div class="card">
                <div class="card-header bg-primary text-white text-uppercase">
                    <i class="fa fa-trophy"></i> Cheapest products
                </div>
                <div class="card-body">
                    <div class="row">
                    <c:forEach items="${top4CheapestProducts }" var="cheapProduct" varStatus="STT">
                        <div class="col-sm">
                            <div class="card">
                                <img class="card-img-top" src="${cheapProduct.images }" alt="Card image cap" width="600" height="280">
                                <div class="card-body">
                                    <h4 class="card-title"><a href="<%=request.getContextPath() %>/user/product?productId=${cheapProduct.productId }" title="View Product">${cheapProduct.productName }</a></h4>
                                    <p class="card-text">${cheapProduct.description}</p>
                                    <div class="row">
                                        <div class="col">
                                            <p class="btn btn-danger btn-block">${cheapProduct.price } $</p>
                                        </div>
                                        <div class="col">
                                            <a href="cart.html" class="btn btn-success btn-block">Add to cart</a>
                                        </div>
